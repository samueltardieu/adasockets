...
private
   ...
   pragma Import (Stdcall, C_Dup2, "dup2");
   pragma Import (Stdcall, C_Fcntl, "fcntl");
   pragma Import (Stdcall, C_Getenv, "getenv");
   ...
   pragma Import (Stdcall, C_Getpid, "getpid");
   ...
   pragma Import (Stdcall, C_Inet_Network, "inet_network");
   pragma Import (Stdcall, C_Inet_Makeaddr, "inet_makeaddr");
   pragma Import (Stdcall, C_Inet_Lnaof, "inet_lnaof");
   pragma Import (Stdcall, C_Inet_Netof, "inet_netof");
   pragma Import (Stdcall, C_Inet_Ntoa, "inet_ntoa");
   pragma Import (Stdcall, C_Kill, "kill");
   pragma Import (Stdcall, C_Listen, "listen");
   pragma Import (Stdcall, C_Msgget, "msgget");
   pragma Import (Stdcall, C_Msgrcv, "msgrcv");
   pragma Import (Stdcall, C_Msgsnd, "msgsnd");
   pragma Import (Stdcall, C_Open, "open");
   pragma Import (Stdcall, C_Recv, "recv");
   pragma Import (Stdcall, C_Recvfrom, "recvfrom");
   pragma Import (Stdcall, C_Recvmsg, "recvmsg");
   pragma Import (Stdcall, C_Send, "send");
   pragma Import (Stdcall, C_Sendmsg, "sendmsg");
   pragma Import (Stdcall, C_Sendto, "sendto");
   pragma Import (Stdcall, C_Setsid, "setsid");
   ...
   pragma Import (Stdcall, C_Strerror, "strerror");
